...
btc_xts$fwd_7d_return_direction <- ifelse(btc_xts$fwd_7d_return > 0, 1, 0)
...
y <- btc_xts$fwd_7d_return_direction
...
index(btc_return_test_period) <- as.Date(index(btc_return_test_period))
...
test_set_performance_xts$gross <-  test_set_performance_xts$btc_return * test_set_performance_xts$selected_model_test_position
...
colnames(final_comparison_xts)[colnames(final_comparison_xts) == "net"] <- "net_ML_class_model"
...
return_cols <- c("btc_return", "net_ML_class_model", "net_sma_inv_vol")
...
selected_model_test_position_prob <- ifelse(selected_model_test_pred_prob$Pos > 0.57,  1, 
                                            ifelse(selected_model_test_pred_prob$Pos < 0.49, -1, 0))
...
test_set_performance_xts_prob <- merge.xts(btc_return_test_period, selected_model_test_position_prob)

test_set_performance_xts_prob <- na.omit(test_set_performance_xts_prob)

test_set_performance_xts_prob$gross <-  test_set_performance_xts_prob$btc_return * test_set_performance_xts_prob$selected_model_test_position_prob
...
charts.PerformanceSummary(test_set_performance_xts_prob[,c(1,3,5)],main = 'Performance Comparison of SVM Probability Model vs Buy and Hold Bitcoin')
...
colnames(final_comparison_xts)[colnames(final_comparison_xts) == "gross.1"] <- "gross_ml_prob_model"
...
return_cols <- c("btc_return", "net_ML_class_model", "net_sma_inv_vol","net_ml_prob_model")
...
latex_table_performance2 <- knitr::kable(
  ...
  align = c("l", "r", "r", "r", "r"),
  col.names = c("Strategy", "Ann. Return", "Ann. Vol", "Sharpe", "Max DD"),
  caption = "Performance comparison of selected Bitcoin strategies",
  label = "tab:performance_comparison",
  escape = FALSE
)
...
btc_classification_and_trend_xts <- merge.xts(test_set_performance_xts, test_set_performance_xts_prob,join = 'inner')
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "selected_model_test_position"] <- "ml_class_model_position"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "gross"] <- "ml_class_model_gross"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "turnover"] <- "ml_class_model_turnover"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "net"] <- "ml_class_model_net_10bp"

colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "selected_model_test_position_prob"] <- "ml_class_prob_model_position"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "gross.1"] <- "ml_class_prob_model_gross"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "turnover.1"] <- "ml_class_prob_model_turnover"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "net.1"] <- "ml_class_prob_model_net_10bp"

btc_classification_and_trend_xts$btc_return.1 <- NULL

btc_classification_and_trend_xts <- merge.xts(btc_classification_and_trend_xts, 
                                              smas_inverse_vol[,c('agg_position','gross', 'turnover', 'net')],join = 'inner')

colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "agg_position"] <- "sma_inv_vol_agg_position"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "gross"] <- "sma_inv_vol_agg_gross"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "turnover"] <- "sma_inv_vol_agg_turnover"
colnames(btc_classification_and_trend_xts)[colnames(btc_classification_and_trend_xts) == "net"] <- "sma_inv_vol_agg_net"

write.zoo(btc_classification_and_trend_xts, file = "btc_classification_and_trend_xts.csv", sep = ",", row.names = FALSE)
