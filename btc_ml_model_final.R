...
btc_regression_and_trend_xts <- final_comparison_xts

colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "position"] <- "btc_ml_model_position"
colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "gross"] <- "btc_ml_model_gross"
colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "turnover"] <- "btc_ml_model_turnover"
colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "net_ML_model"] <- "btc_ml_model_net_10bp"


colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "position_sma_inv_vol"] <- "btc_sma_inv_vol_agg_position"
colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "gross_sma_inv_vol"] <- "btc_sma_inv_vol_agg_gross"
colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "net_sma_inv_vol"] <- "btc_sma_inv_vol_agg_net"

btc_regression_and_trend_xts <- merge.xts(btc_regression_and_trend_xts, smas_inverse_vol[,c('turnover')],join = 'inner')

colnames(btc_regression_and_trend_xts)[colnames(btc_regression_and_trend_xts) == "turnover"] <- "btc_sma_inv_vol_agg_turnover"


write.zoo(btc_regression_and_trend_xts, file = "btc_regression_and_trend_xts.csv", sep = ",", row.names = FALSE)
